...
Partial Class RentalForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.RentalFormToolTip.SetToolTip(Me.NameLabel, "The Customer's Name")
        '
        'AddressLabel
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.AddressLabel, "The Customer's Address")
        '
        'CityLabel
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.CityLabel, "The Customer's City")
        '
        'State4
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.State4, "The Customer's State")
        '
        'ZipCodeLabel
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.ZipCodeLabel, "The Customer's Zip Code")
        '
        'BeginOdometerLabel
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.BeginOdometerLabel, "The Customer's Odometer Reading Before Their Trip")
        '
        'EndOdometerLabel
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.EndOdometerLabel, "The Customer's Odometer Reading After Their Trip")
        '
        'DaysLabel
        '
        ...
        Me.BeginOdometerTextBox.MaxLength = 999999999
        ...
        Me.EndOdometerTextBox.MaxLength = 999999999
        ...
        Me.RentalFormToolTip.SetToolTip(Me.Seniorcheckbox, "If the customer is a senior citizen (65 or older) they receive a 3% discount.")
        ...
        Me.RentalFormToolTip.SetToolTip(Me.AAAcheckbox, "If the customer is an AAA member, they receive a 5% discount")
        ...
        Me.RentalFormToolTip.SetToolTip(Me.ClearButton, "Clears all fields and all stored data")
        ...
        Me.RentalFormToolTip.SetToolTip(Me.ExitButton, "Exits the program.")
        ...
        Me.RentalFormToolTip.SetToolTip(Me.MileChargeLabel, "First 200 miles are free, mile 201 to 500 is  $0.12/mile, and $0.1/mile afterward" &
        "s.")
        '
        'DayChargeLabel
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.DayChargeLabel, "$15.00/Day")
        '
        'DiscountLabel
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.DiscountLabel, "Discounts")
        '
        'YouOweLabel
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.YouOweLabel, "Final Total")
        '
        'HDivLabel
        '
        ...
        Me.RentalFormToolTip.SetToolTip(Me.SummaryButton, "Provides a summary of all customers and relevant totals. ")
